# Getting Started with Netzbremse Routemonitor

This guide will help you install and set up the Netzbremse Routemonitor custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/MeikTranel/hacs-netzbremse-routemonitor`
6. Set category to "Integration"
7. Click "Add"
8. Find "Netzbremse Routemonitor" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/MeikTranel/hacs-netzbremse-routemonitor/releases)
2. Extract the `netzbremse_routemonitor` folder from the archive
3. Copy it to `custom_components/netzbremse_routemonitor/` in your Home Assistant configuration directory
...
4. Select entities from "Netzbremse Routemonitor"
...
- Report issues at [GitHub Issues](https://github.com/MeikTranel/hacs-netzbremse-routemonitor/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/MeikTranel/hacs-netzbremse-routemonitor/discussions)
