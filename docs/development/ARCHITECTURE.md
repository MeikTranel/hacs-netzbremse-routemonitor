...
This document describes the technical architecture of the Netzbremse Routemonitor custom component for Home Assistant.

## Directory Structure

```text
custom_components/netzbremse_routemonitor/
...
│   ├── __init__.py          # Exports NetzbremseRoutemonitorDataUpdateCoordinator
...
│   ├── __init__.py          # Exports NetzbremseRoutemonitorEntity
...
- `base.py` - Main coordinator class (`NetzbremseRoutemonitorDataUpdateCoordinator`)
...
**Key class:** `NetzbremseRoutemonitorDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `NetzbremseRoutemonitorApiClient`
...
- `NetzbremseRoutemonitorConfigFlowHandler` (main flow)
- `NetzbremseRoutemonitorOptionsFlow` (options)
...
**Key class:** `NetzbremseRoutemonitorEntity` (in `entity/base.py`)
...
2. `NetzbremseRoutemonitorEntity` for common functionality
...
1. Create directory: `custom_components/netzbremse_routemonitor/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `NetzbremseRoutemonitorEntity`
