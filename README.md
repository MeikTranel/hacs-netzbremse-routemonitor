...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/MeikTranel/hacs-netzbremse-routemonitor?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hacs-netzbremse-routemonitor&category=integration)
...
1. Download the `custom_components/netzbremse_routemonitor/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=netzbremse_routemonitor)
...
3. Search for "Netzbremse Routemonitor"
...
1. Go to **Settings** → **Devices & Services**
2. Find **Netzbremse Routemonitor**
...
Find all entities in **Settings** → **Devices & Services** → **Netzbremse Routemonitor** → click on the device.
...
### `netzbremse_routemonitor.example_action`
...
```yaml
service: netzbremse_routemonitor.example_action
data:
  # Add your parameters here
```

### `netzbremse_routemonitor.reload_data`
...
```yaml
service: netzbremse_routemonitor.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.netzbremse_routemonitor: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Netzbremse Routemonitor → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@MeikTranel][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/MeikTranel/hacs-netzbremse-routemonitor.svg?style=for-the-badge
[commits]: https://github.com/MeikTranel/hacs-netzbremse-routemonitor/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/MeikTranel/hacs-netzbremse-routemonitor.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40MeikTranel-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/MeikTranel/hacs-netzbremse-routemonitor.svg?style=for-the-badge
[releases]: https://github.com/MeikTranel/hacs-netzbremse-routemonitor/releases
