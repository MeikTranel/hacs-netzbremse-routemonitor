"""
Base entity class for netzbremse_routemonitor.
...
from custom_components.netzbremse_routemonitor.const import ATTRIBUTION
...
class NetzbremseRoutemonitorEntity(CoordinatorEntity[NetzbremseRoutemonitorDataUpdateCoordinator]):
    """
    Base entity class for netzbremse_routemonitor.
