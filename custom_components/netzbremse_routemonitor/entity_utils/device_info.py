"""Device info utilities for netzbremse_routemonitor."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Netzbremse Routemonitor",
        manufacturer=manufacturer or "Netzbremse Routemonitor",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('netzbremse_routemonitor', 'entry_id_value')}
    """
