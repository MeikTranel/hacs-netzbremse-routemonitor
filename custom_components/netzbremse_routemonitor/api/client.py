"""
API Client for netzbremse_routemonitor.
...
class NetzbremseRoutemonitorApiClientError(Exception):
    """Base exception to indicate a general API error."""


class NetzbremseRoutemonitorApiClientCommunicationError(
    NetzbremseRoutemonitorApiClientError,
):
    """Exception to indicate a communication error with the API."""


class NetzbremseRoutemonitorApiClientAuthenticationError(
    NetzbremseRoutemonitorApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        NetzbremseRoutemonitorApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise NetzbremseRoutemonitorApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class NetzbremseRoutemonitorApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            NetzbremseRoutemonitorApiClientAuthenticationError: If authentication fails.
            NetzbremseRoutemonitorApiClientCommunicationError: If communication fails.
            NetzbremseRoutemonitorApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise NetzbremseRoutemonitorApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise NetzbremseRoutemonitorApiClientError(
                msg,
            ) from exception
