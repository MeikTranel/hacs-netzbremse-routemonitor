"""Number platform for netzbremse_routemonitor."""
...
from .target_humidity import ENTITY_DESCRIPTIONS as HUMIDITY_DESCRIPTIONS, NetzbremseRoutemonitorHumidityNumber
...
async def async_setup_entry(
    ...
    async_add_entities(
        NetzbremseRoutemonitorHumidityNumber(
