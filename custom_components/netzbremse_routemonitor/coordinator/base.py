"""
Core DataUpdateCoordinator implementation for netzbremse_routemonitor.
...
from custom_components.netzbremse_routemonitor.api import (
    NetzbremseRoutemonitorApiClientAuthenticationError,
    NetzbremseRoutemonitorApiClientError,
)
from custom_components.netzbremse_routemonitor.const import LOGGER
...
class NetzbremseRoutemonitorDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: NetzbremseRoutemonitorConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except NetzbremseRoutemonitorApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="netzbremse_routemonitor",
                translation_key="authentication_failed",
            ) from exception
        except NetzbremseRoutemonitorApiClientError as exception:
