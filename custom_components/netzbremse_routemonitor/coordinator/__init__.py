"""
Data update coordinator package for netzbremse_routemonitor.
...
from .base import NetzbremseRoutemonitorDataUpdateCoordinator

__all__ = ["NetzbremseRoutemonitorDataUpdateCoordinator"]
