"""Sensor platform for netzbremse_routemonitor."""
...
from .air_quality import ENTITY_DESCRIPTIONS as AIR_QUALITY_DESCRIPTIONS, NetzbremseRoutemonitorAirQualitySensor
from .diagnostic import ENTITY_DESCRIPTIONS as DIAGNOSTIC_DESCRIPTIONS, NetzbremseRoutemonitorDiagnosticSensor
...
async def async_setup_entry(
    ...
    async_add_entities(
        NetzbremseRoutemonitorAirQualitySensor(
    ...
    async_add_entities(
        NetzbremseRoutemonitorDiagnosticSensor(
            coordinator=entry.runtime_data.coordinator,
            entity_description=entity_description,
        )
