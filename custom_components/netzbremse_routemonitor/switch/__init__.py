"""Switch platform for netzbremse_routemonitor."""
...
from .example_switch import ENTITY_DESCRIPTIONS as SWITCH_DESCRIPTIONS, NetzbremseRoutemonitorSwitch
