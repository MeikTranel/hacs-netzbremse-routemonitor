"""
Custom integration to integrate netzbremse_routemonitor with Home Assistant.
...
https://github.com/MeikTranel/hacs-netzbremse-routemonitor
...
from .data import NetzbremseRoutemonitorData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import NetzbremseRoutemonitorConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = NetzbremseRoutemonitorData(
        client=client,
