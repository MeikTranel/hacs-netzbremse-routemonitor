...
from custom_components.netzbremse_routemonitor.api import NetzbremseRoutemonitorApiClient
...
async def validate_credentials(hass: HomeAssistant, username: str, password: str) -> None:
    ...
    Raises:
        NetzbremseRoutemonitorApiClientAuthenticationError: If credentials are invalid.
