"""
Config flow for netzbremse_routemonitor.
...
from custom_components.netzbremse_routemonitor.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.netzbremse_routemonitor.config_flow_handler.validators import validate_credentials
from custom_components.netzbremse_routemonitor.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME

if TYPE_CHECKING:
    from custom_components.netzbremse_routemonitor.config_flow_handler.options_flow import (
        NetzbremseRoutemonitorOptionsFlow,
    )

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "NetzbremseRoutemonitorApiClientAuthenticationError": "auth",
    "NetzbremseRoutemonitorApiClientCommunicationError": "connection",
}


class NetzbremseRoutemonitorConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for netzbremse_routemonitor.
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.netzbremse_routemonitor.config_flow_handler.options_flow import (  # noqa: PLC0415
            NetzbremseRoutemonitorOptionsFlow,
        )
...
__all__ = ["NetzbremseRoutemonitorConfigFlowHandler"]
