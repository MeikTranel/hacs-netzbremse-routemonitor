"""
Options flow for netzbremse_routemonitor.
...
from custom_components.netzbremse_routemonitor.config_flow_handler.schemas import get_options_schema
from homeassistant import config_entries


class NetzbremseRoutemonitorOptionsFlow(config_entries.OptionsFlow):
    """
...
__all__ = ["NetzbremseRoutemonitorOptionsFlow"]
