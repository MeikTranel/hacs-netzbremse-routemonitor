...
- Create new sensor file in `custom_components/netzbremse_routemonitor/sensor/`
- Inherit from `NetzbremseRoutemonitorEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Netzbremse Routemonitor."""
...
class NetzbremseRoutemonitor[SensorName]Sensor(
...
- Entity: `custom_components/netzbremse_routemonitor/sensor/[sensor_name].py`
- Platform: `custom_components/netzbremse_routemonitor/sensor/__init__.py`
- Translations: `custom_components/netzbremse_routemonitor/translations/*.json`
