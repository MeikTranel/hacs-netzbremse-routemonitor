...
- Inherit from `NetzbremseRoutemonitorEntity` and platform base class
...
- Entity: `custom_components/netzbremse_routemonitor/[platform]/[entity_name].py`
- Platform: `custom_components/netzbremse_routemonitor/[platform]/__init__.py`
