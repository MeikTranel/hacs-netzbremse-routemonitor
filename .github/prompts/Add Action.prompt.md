...
**File:** `custom_components/netzbremse_routemonitor/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: netzbremse_routemonitor
...
Create `custom_components/netzbremse_routemonitor/service_actions/[action_name].py`:

```python
"""[Action name] service action for Netzbremse Routemonitor."""
...
**File:** `custom_components/netzbremse_routemonitor/__init__.py`
...
**File:** `custom_components/netzbremse_routemonitor/const.py`
...
3. Find service action: `netzbremse_routemonitor.[action_name]`
...
- **Service actions directory:** `custom_components/netzbremse_routemonitor/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/netzbremse_routemonitor/services.yaml` (legacy filename)
- **Icons:** `custom_components/netzbremse_routemonitor/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/netzbremse_routemonitor/translations/*.json` under `services` key (legacy)
