...
- `entity/` - Base entity class (`NetzbremseRoutemonitorEntity`)
...
- All entities inherit: `(PlatformEntity, NetzbremseRoutemonitorEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.netzbremse_routemonitor: debug` in `config/configuration.yaml`
