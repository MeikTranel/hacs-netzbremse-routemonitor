...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `NetzbremseRoutemonitor`
...
- Inherit from both platform entity and `NetzbremseRoutemonitorEntity` (order matters)
...
from custom_components.netzbremse_routemonitor.sensor import async_setup_entry
...
**Config entry data:** `entry_data: NetzbremseRoutemonitorData = hass.data[DOMAIN][entry.entry_id]`
