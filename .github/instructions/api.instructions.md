...
- `NetzbremseRoutemonitorApiClientError` (Base)
- `NetzbremseRoutemonitorApiClientCommunicationError` (Network, timeout, HTTP errors)
- `NetzbremseRoutemonitorApiClientAuthenticationError` (401, 403, invalid credentials)
