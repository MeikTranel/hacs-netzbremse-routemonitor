...
- **`entity/`** - Base entity classes (inherit `NetzbremseRoutemonitorEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, NetzbremseRoutemonitorEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import NetzbremseRoutemonitorEntity`
